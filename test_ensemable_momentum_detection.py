...
from test_datasets_detection import *
from utils import *
...
parser.add_argument('--ckpt', type=str, default='/home/fyb/code/0_816_version_EnsemableTeacher_corr_OnlineDistill_confidence_4recurrentFast_noMS_LargerModel_tune08_ReduceSize/logs/edge_detection/20230223-231152/weights/ckt_0017.pth')
...
dataloader = DataLoader(ImageDataset("/home/yuanbinfu/xin/xin/", transforms_=transforms_, unaligned=True),
...
edge_path_formal = "baseline_result_ep_EnsemableTeacher_corr_OnlineDistill_confidence_4recurrentFast_xin_LargerModel_tune08_ReduceSize_ensemble_" + opt.ckpt.strip().strip('/').split('/')[-1]
edge_path_formal1 = "baseline_result_ep_EnsemableTeacher_corr_OnlineDistill_confidence_4recurrentFast_xin_LargerModel_tune08_ReduceSize_" + opt.ckpt.strip().strip('/').split('/')[-1]
edge_path_formal2 = "baseline_result_ep_EnsemableTeacher_corr_OnlineDistill_confidence_4recurrentFast_xin_LargerModel_tune08_ReduceSize_noshare_" + opt.ckpt.strip().strip('/').split('/')[-1]
